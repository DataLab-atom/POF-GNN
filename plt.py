...
for run_time in range(RUNNING_TIME):
    ...
    alphas = np.linspace(0.01, 1, 5)
    for alpha in alphas:
        cls_loss_save = 0
        parity_loss_save = 0
        equality_loss_save = 0
        parity_equality_loss_save = 0
        for epoch in range(args.epochs):
            ...
            cls_loss_save=cls_loss
            parity_loss_save=parity_loss
            equality_loss_save=equality_loss
            parity_equality_loss_save=parity_loss + equality_loss
        ...
        cls_loss_list.append(cls_loss_save)
        parity_loss_list.append(parity_loss_save)
        equality_loss_list.append(equality_loss_save)
        parity_equality_loss_list.append(parity_equality_loss_save)
    ...
    plt.scatter(cls_loss_list, parity_equality_loss_list,c=alphas, cmap='viridis')
    ...
    plt.show()
    print("cls_loss_list",cls_loss_list)
    print("parity_equality_loss_list",parity_equality_loss_list)
